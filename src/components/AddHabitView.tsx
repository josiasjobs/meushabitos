...
interface AddHabitViewProps {
  onSave: (name: string, days: number[]) => void;
  onCancel: () => void;
}

const AddHabitView: React.FC<AddHabitViewProps> = ({ onSave, onCancel }) => {
    ...
    <div className="animate-slide-up">
      ...
      <div className="card-gradient rounded-xl p-6 shadow-lg space-y-6">
        <div className="space-y-2">
          <Label htmlFor="habit-name" className="text-gray-700 font-medium">
            Nome do hábito
          </Label>
          <Input
            id="habit-name"
            type="text"
            placeholder="Ex: Exercitar-se, Ler 30 minutos..."
            value={name}
